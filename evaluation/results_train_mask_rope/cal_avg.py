...
if __name__ == "__main__":
    ...
    for ratio in default_ratio:
        # default_path = f"ruler__4096__llama3.1-8b-instruct-memory-larger-9210__query_indexer_score_top_p__cr{ratio}__compressed_questions/metrics.json"
        default_path = f"ruler__4096__llama3.1-8b-instruct-query_indexer_score_larger-6140__query_indexer_score_top_p__cr{ratio}__compressed_questions/metrics.json"
