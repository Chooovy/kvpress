...
if __name__ == "__main__":
    ...
    for ratio in default_ratio:
        # default_path = f"ruler__4096__llama3.1-8b-instruct-memory-two_step__memory_query_indexer_last128__cr{ratio}__compressed_questions/1/metrics.json"
        default_path = f"ruler__4096__llama3.1-8b-instruct-memory-two_step__memory_query_indexer_top_p__cr{ratio}__compressed_questions/1/metrics.json"
