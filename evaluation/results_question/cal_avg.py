...
if __name__ == "__main__":
    ...
    for ratio in default_ratio:
        default_path = f"ruler__4096__llama3.1-8b-instruct-query-indexer_score_long__query_indexer_score_question__cr{ratio}__compressed_questions/metrics.json"
        # default_path = f"ruler__4096__Llama-3.1-8B-Instruct__kvzip__cr{ratio}/metrics.json"
