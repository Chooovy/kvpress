...
if __name__ == "__main__":
    default_ratio = (0.10, 0.25, 0.5, 0.75, 0.9)
    for ratio in default_ratio:
        default_path = f"ruler__4096__llama3.1-8b-instruct-query-indexer_score_long__query_indexer_score__cr{ratio}/1/metrics.json"
